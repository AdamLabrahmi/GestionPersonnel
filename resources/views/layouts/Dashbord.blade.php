    ...
    <head>
        ...
        <link rel="icon" type="image/svg+xml" href="{{asset('images/ofppt.png')}}" />
    ...
    *, ::before, ::after{
    ...
    <div class="fixed left-0 top-0 w-64 h-full bg-[#f8f4f3] p-4 z-50 sidebar-menu transition-transform">
        <a href="#" class="flex items-center pb-4 border-b border-b-gray-800">
            <h2 class="font-bold text-2xl">OFPPT <span class="bg-[#005ca9] text-white px-2 rounded-md">ISGI</span></h2>
        </a>
        <ul class="mt-4">
            <li class="mb-1 group">
                <a href="{{route('absences.index')}}" class="flex font-semibold items-center py-2 px-4 text-gray-900 hover:bg-gray-950 hover:text-gray-100 rounded-md group-[.active]:bg-gray-800 group-[.active]:text-white group-[.selected]:bg-gray-950 group-[.selected]:text-gray-100">
        ...
        <li class="mb-1 group">
            <a href="{{route('mat')}}" class="flex font-semibold items-center py-2 px-4 text-gray-900 hover:bg-gray-950 hover:text-gray-100 rounded-md group-[.active]:bg-gray-800 group-[.active]:text-white group-[.selected]:bg-gray-950 group-[.selected]:text-gray-100">
                <i class="fas fa-search mr-3 text-lg"></i>
                <span class="text-sm">Chercher un matricule</span>
            </a>
        </li>
        <li class="mb-1 group">
            <a href="{{route('demandes.create')}}" class="flex font-semibold items-center py-2 px-4 text-gray-900 hover:bg-gray-950 hover:text-gray-100 rounded-md group-[.active]:bg-gray-800 group-[.active]:text-white group-[.selected]:bg-gray-950 group-[.selected]:text-gray-100">
                <i class="fas fa-plus-circle mr-3 text-lg"></i>
                <span class="text-sm">Ajouter une demande d'absence</span>
            </a>
        </li>
        <li class="mb-1 group">
            <a href="{{route('demandes.index')}}" class="flex font-semibold items-center py-2 px-4 text-gray-900 hover:bg-gray-950 hover:text-gray-100 rounded-md group-[.active]:bg-gray-800 group-[.active]:text-white group-[.selected]:bg-gray-950 group-[.selected]:text-gray-100">
                <i class="fas fa-bell mr-3 text-lg"></i>
                <span class="text-sm">Les nouvelles demande d'absence</span>
            </a>
        </li>
    ...
    <main class="w-full md:w-[calc(100%-256px)] md:ml-64 bg-gray-200 min-h-screen transition-all main">
                    ...
                    <button type="button" class="dropdown-toggle flex items-center">
                        <div class="flex-shrink-0 w-10 h-10 relative">
                            <div class="p-1 bg-white rounded-full focus:outline-none focus:ring">
                                <img class="w-8 h-8 rounded-full" src="{{ asset('images/User.png') }}" alt=""/> {{--photo--}}
                                <div class="top-0 left-7 absolute w-3 h-3 bg-lime-400 border-2 border-white rounded-full animate-ping"></div>
                                <div class="top-0 left-7 absolute w-3 h-3 bg-lime-500 border-2 border-white rounded-full"></div>
                            </div>
                        </div>
                        <div class="p-2 md:block text-left">
                            <h2 class="text-sm font-semibold text-gray-800">Admin</h2> {{--name--}}
                            <p class="text-xs text-gray-500">Administrator</p>{{--Role--}}
                        </div>
                    </button>
        ...
        <main class="container mx-auto px-4 bg-white rounded mb-8">
...
<script>
    $(document).ready(function() {
        ...
        $('#type_formateur, #date_debut, #filiere_formateur, #role_personnel').change(function() {
            // Soumettre le formulaire lorsqu'un changement est détecté
            $('form').submit();
        });
    });
</script>
